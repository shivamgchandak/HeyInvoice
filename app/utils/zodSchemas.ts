...
export const invoiceSchema = z.object({
    ...
    invoiceItemDiscount: z.number().min(0, "Discount cannot be negative").max(100, "Discount cannot exceed 100%"),
    invoiceItemTax: z.number().min(0, "Tax cannot be negative").max(100, "Tax cannot exceed 100%"),
});