...
export function EditInvoice({ data }: iAppProps) {
    ...
    // Hydrate items - prefer the new items[] relation; fall back to legacy single-item
            ...
            : [
                  {
                      ...
                      quantity: (data.invoiceItemQuantity ?? 0).toString(),
                      rate: (data.invoiceItemRate ?? 0).toString(),
                      discount: (data.invoiceItemDiscount ?? 0).toString(),
                      tax: (data.invoiceItemTax ?? 0).toString(),
                  },
              ];
